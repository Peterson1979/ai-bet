        ...
        <div className="mx-auto max-w-[1500px] px-4 md:px-6 pb-16">
          ...
          <div className="mt-12 rounded-2xl border border-yellow-400/20 bg-yellow-500/5 p-6">
            <p className="text-sm text-slate-300 leading-6">
              <strong className="text-yellow-300">Affiliate Disclosure:</strong> This page contains affiliate links.
              We may receive a commission when you sign up through our links, at no extra cost to you.
              Always gamble responsibly. 18+ only. Check local laws before betting.
            </p>
          </div>
