...
export const AFFILIATE_SITES: AffiliateSite[] = [
  ...
  },
  {
    ...
    name: "Vipsta",
    rating: 8.5,
    bonus: "Welcome Bonus Offer",
    baseUrl: "https://go.whiteclickaffiliates.com/visit/?bta=40740&nci=5371",
    aliases: ["vipsta", "vipsta sports", "vipstabet"],
    sports: [
      "Football",
      "NBA",
      "NFL",
  ...
  },
  {
    ...
    rating: 8.5,
    bonus: "Welcome Bonus Offer",
    baseUrl: "https://go.afftrackio.com/visit/?bta=36402&nci=5358",
    aliases: ["tenobet", "teno bet"],
    sports: [
      "Football",
      "NBA",
      "NFL",
  ...
  },
  {
    ...
    rating: 8.4,
    bonus: "Welcome Bonus Offer",
    baseUrl: "https://revery-l.ink/jz2mphcu1",
    aliases: ["reveryplay", "revery play", "revery"],
    sports: [
      "Football",
      "NBA",
      "NFL",
  ...
  },
  {
    ...
    rating: 8.4,
    bonus: "Welcome Bonus Offer",
    baseUrl: "https://trackingwoolbet.com/davqbmnn9",
    aliases: ["woolbet", "wool bet"],
    sports: [
      "Football",
      "NBA",
      "NFL",
  ...
  },
  {
    ...
    rating: 8.3,
    bonus: "Welcome Bonus Offer",
    baseUrl: "https://vgr.lynmonkel.com/?mid=247905_2230662",
    aliases: ["vegashero", "vegas hero"],
    sports: [
      "Football",
      "NBA",
      "NFL",
  ...
  },
  {
    ...
    rating: 8.3,
    bonus: "Welcome Bonus Offer",
    baseUrl: "https://mgs.lynmonkel.com/?mid=247905_2230655",
    aliases: ["magius", "magius sports", "magiusbet"],
    sports: [
      "Football",
      "NBA",
      "NFL",
  ...
  },
  {
    ...
    rating: 8.2,
    bonus: "Welcome Bonus Offer",
    baseUrl: "https://crtwr.lynmonkel.com/?mid=230354_2230470",
    aliases: ["crazytower", "crazy tower"],
    sports: [
      "Football",
      "NBA",
      "NFL",
  ...
  },
  {
    ...
    rating: 8.2,
    bonus: "Welcome Bonus Offer",
    baseUrl: "https://slplc.lynmonkel.com/?mid=247905_2230670",
    aliases: ["casoola", "casoola sports", "casoolabet"],
    sports: [
      "Football",
      "NBA",
      "NFL",
  ...
  },
  {
    ...
    rating: 8.1,
    bonus: "Welcome Bonus Offer",
    baseUrl: "https://redirspinner.com/35d9?p=%2Fbonus%2Frules%2F1st",
    aliases: ["spinbetter", "spin better"],
    sports: [
      "Football",
      "NBA",
      "NFL",
