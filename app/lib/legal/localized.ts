...
const hu = build({
  ...
  privacy: {
    ...
    intro: "Ez a tájékoztató bemutatja, hogyan kezeli a MatchSignal a személyes adatokat a GDPR szerint. A MatchSignal határozza meg az itt leírt adatkezelések célját és eszközeit, ezért adatkezelő.",
    sections: [
  ...
  notice: { title: "Jogi nyilatkozat / Impresszum", description: "A MatchSignal üzemeltetői, kapcsolati és tárhelyadatai.", intro: "Weboldal: MatchSignal · https://www.matchsignal.pro. A MatchSignal tájékoztató sportelemző oldal, nem fogadóiroda, szerencsejáték- vagy fizetési szolgáltató.", sections: [
    ["Üzemeltető és felelősség", "A MatchSignal a weboldal karbantartója és technikai üzemeltetője, a kereskedelmi és affiliate tevékenység üzemeltetője, valamint adatkezelő, ahol a MatchSignal határozza meg az adatkezelés célját."],
...
const de = build({
  ...
  privacy: { title: "Datenschutzerklärung", description: "Verarbeitung personenbezogener Daten durch MatchSignal, einschließlich Kontakt, Analyse, Werbung und Affiliate-Interaktionen.", intro: "Diese Erklärung beschreibt die Verarbeitung nach der DSGVO. MatchSignal bestimmt die Zwecke und Mittel der hier beschriebenen Verarbeitungen und ist Verantwortlicher.", sections: [
  ...
  notice: { title: "Impressum / Rechtliche Hinweise", description: "Betreiber-, Kontakt- und Hostingangaben für MatchSignal.", intro: "Website: MatchSignal · https://www.matchsignal.pro. MatchSignal ist eine Informationsseite für Sportanalysen und kein Buchmacher, Glücksspiel- oder Zahlungsanbieter.", sections: [
    ["Betreiber", "MatchSignal ist Website-Betreiber und technisch Verantwortlicher, Betreiber der kommerziellen/Affiliate-Tätigkeit sowie Verantwortlicher, wo MatchSignal Zwecke der Datenverarbeitung bestimmt."],
...
const fr = build({
  ...
  privacy: { title: "Politique de confidentialité", description: "Traitement des données personnelles par MatchSignal : contact, analyse, publicité et affiliation.", intro: "Cette notice explique le traitement au titre du RGPD. MatchSignal détermine les finalités et moyens décrits ici et agit comme responsable du traitement.", sections: [
  ...
  notice: { title: "Mentions légales", description: "Exploitant, contacts et hébergement de MatchSignal.", intro: "Site : MatchSignal · https://www.matchsignal.pro. MatchSignal est un site informatif d'analyse sportive, pas un bookmaker, opérateur de jeu ou prestataire de paiement.", sections: [
    ["Exploitant", "MatchSignal assure la maintenance et l'exploitation technique, l'activité commerciale/affiliation, et agit comme responsable lorsque MatchSignal détermine les finalités."],
...
const es = build({
  ...
  privacy: { title: "Política de privacidad", description: "Tratamiento de datos personales por MatchSignal: contacto, analítica, publicidad y afiliación.", intro: "Este aviso explica el tratamiento conforme al RGPD. MatchSignal determina los fines y medios aquí descritos y es el responsable del tratamiento.", sections: [
  ...
  notice: { title: "Aviso legal", description: "Operador, contactos y alojamiento de MatchSignal.", intro: "Sitio: MatchSignal · https://www.matchsignal.pro. Es un sitio informativo de análisis deportivo, no casa de apuestas, operador de juego ni pagos.", sections: [
    ["Operador", "MatchSignal mantiene y opera técnicamente el sitio, opera la actividad comercial/afiliada y es responsable cuando MatchSignal determina fines del tratamiento."],
...
const it = build({
  ...
  notice: { title: "Note legali", description: "Titolare, contatti e hosting MatchSignal.", intro: "Sito: MatchSignal · https://www.matchsignal.pro. È un sito informativo di analisi sportiva, non bookmaker, operatore di gioco o pagamenti.", sections: [
    ["Titolare", "MatchSignal mantiene e gestisce tecnicamente il sito, gestisce attività commerciale/affiliata ed è titolare quando MatchSignal determina le finalità."],
...
const pt = build({
  ...
  privacy: { title: "Política de privacidade", description: "Tratamento de dados pessoais pelo MatchSignal: contacto, análises, publicidade e afiliação.", intro: "Este aviso explica o tratamento ao abrigo do RGPD. O MatchSignal determina as finalidades e os meios aqui descritos e é responsável pelo tratamento.", sections: [
  ...
  notice: { title: "Aviso legal", description: "Operador, contactos e alojamento MatchSignal.", intro: "Site: MatchSignal · https://www.matchsignal.pro. É um site informativo de análise desportiva, não casa de apostas, operador de jogo ou pagamentos.", sections: [
    ["Operador", "O MatchSignal mantém e opera tecnicamente o site, gere atividade comercial/afiliada e é responsável quando o MatchSignal determina finalidades."],
...
const ar = build({
  ...
  privacy: { title: "سياسة الخصوصية", description: "معالجة MatchSignal للبيانات الشخصية في الاتصال والتحليلات والإعلانات والإحالة.", intro: "يشرح هذا الإشعار المعالجة بموجب اللائحة العامة لحماية البيانات. تحدد MatchSignal الأغراض والوسائل الموضحة هنا، ولذلك فهي المتحكمة بالبيانات.", sections: [
  ...
  notice: { title: "إشعار قانوني", description: "المشغّل والاتصالات والاستضافة لدى MatchSignal.", intro: "الموقع: MatchSignal · https://www.matchsignal.pro. هو موقع معلومات وتحليل رياضي، وليس موقع مراهنات أو مشغل قمار أو دفع.", sections: [
    ["المشغّل", "MatchSignal تصون الموقع وتشغله تقنيًا، وتدير النشاط التجاري والإحالة، وتكون المتحكمة عندما تحدد MatchSignal أغراض المعالجة."],
...
const zh = build({
  ...
  privacy: { title: "隐私政策", description: "MatchSignal 对联系、分析、广告及联盟互动中的个人数据处理说明。", intro: "本说明依据 GDPR 解释数据处理。MatchSignal 决定本文所述处理的目的与方式，因此担任数据控制者。", sections: [
  ...
  notice: { title: "法律声明", description: "MatchSignal 运营者、联系方式及托管信息。", intro: "网站：MatchSignal · https://www.matchsignal.pro。MatchSignal 是体育分析信息网站，不是博彩公司、赌博或支付运营商。", sections: [
    ["运营者", "MatchSignal 负责网站维护和技术运营、商业/联盟活动，并在 MatchSignal 决定处理目的时担任数据控制者。"],
...
const ja = build({
  ...
  privacy: { title: "プライバシーポリシー", description: "連絡、分析、広告、アフィリエイトにおける MatchSignal の個人データ処理。", intro: "本通知は GDPR に基づく処理を説明します。MatchSignal はここに記載する処理の目的と手段を決定するデータ管理者です。", sections: [
  ...
  notice: { title: "法的表示", description: "MatchSignal の運営者、連絡先、ホスティング。", intro: "サイト：MatchSignal · https://www.matchsignal.pro。スポーツ分析情報サイトで、ブックメーカー、賭博、決済事業者ではありません。", sections: [
    ["運営者", "MatchSignal はサイト保守・技術運営、商業/アフィリエイト活動を行い、MatchSignal が処理目的を決める場合のデータ管理者です。"],
...
const hi = build({
  ...
  privacy: { title: "गोपनीयता नीति", description: "संपर्क, एनालिटिक्स, विज्ञापन और एफिलिएट संवाद में MatchSignal द्वारा व्यक्तिगत डेटा प्रसंस्करण।", intro: "यह सूचना GDPR के अंतर्गत प्रसंस्करण समझाती है। MatchSignal यहाँ वर्णित उद्देश्य और साधन तय करती हैं और डेटा नियंत्रक हैं।", sections: [
  ...
  notice: { title: "कानूनी सूचना", description: "MatchSignal operator, contacts और hosting।", intro: "Website: MatchSignal · https://www.matchsignal.pro। यह sports-analysis information site है, sportsbook, gambling operator या payment provider नहीं।", sections: [
    ["Operator", "MatchSignal website maintenance/technical operation, commercial/affiliate activity चलाती हैं और जहाँ MatchSignal processing purposes तय करता है वहाँ data controller हैं।"],
