...
function doc(
  ...
  options: Pick<LegalDocument, "showCookieSettings" | "updated"> = { updated }
): LegalDocument {
...
const en: LegalLocaleContent = {
  "privacy-policy": doc(
    ...
    ["This notice explains how MatchSignal processes personal data and how you can exercise your rights under the General Data Protection Regulation (GDPR). MatchSignal determines the purposes and means of the processing described here and is the data controller."],
    [
  ...
  "cookie-policy": doc(
    ...
    { showCookieSettings: true, updated }
  ),
  ...
  "legal-notice": doc("Legal Notice", "Operator, contact and hosting information for MatchSignal.", ["Website: MatchSignal · https://www.matchsignal.pro. MatchSignal is an informational sports-analysis website and is not a sportsbook, gambling operator or payment provider."], [
    { heading: "Operator and responsibility", paragraphs: ["MatchSignal is both the website maintainer / technical operator and the commercial / affiliate activity operator, and is the data controller where MatchSignal determines the purposes and means of personal-data processing."] },
