...
const hu: DeepPartial<Translation> = {
  ...
  affiliateDisclaimer: "Egyes fogadóiroda linkek partneri (affiliate) linkek. A MatchSignal jutalékot kaphat, Önnek ez nem jelent többletköltséget.",
  homepageNoPicksTitle: "Jelenleg nincsenek elérhető élő tippek",
...
"Igen, a MatchSignal ingyenes, mesterséges intelligenciával működő fogadási előrejelzéseket és mérkőzéselemzést biztosít.",
  ...
  featuredSportsbooks: {
    title: "Kiemelt Fogadóirodák",
    subtitle: "Fedezze fel partner fogadóirodáinkat és az elérhető ajánlatokat.",
    seeAll: "Összes fogadóiroda megtekintése →",
  },
  partnerSportsbooks: {
    title: "Partner Fogadóirodák",
    compareAll: "Összes fogadóiroda összehasonlítása →",
    viewOffer: "Ajánlat megtekintése →",
  },
  stickyCta: {
    text: "Fogadási Bónuszok — Ajánlatok összehasonlítása →",
  },
  bettingPage: {
    title: "Fogadóiroda Katalógus",
    description: "Partner fogadóirodák, üdvözlő bónuszok és funkciók áttekintése.",
    titleMainPrefix: "Fogadóiroda",
    titleMainHighlight: "Katalógus",
    subtitle: "Hasonlítsa össze a partnerirodákat, elérhető ajánlatokat és funkciókat.",
    recommended: "Kiemelt",
    partnerBadge: "Kiemelt Partner",
    siteDescription: "Partner fogadóiroda sportfogadási piacokkal, szorzókkal és elérhető ajánlatokkal.",
    claimBonus: "Üdvözlő ajánlat",
    visitSite: "Látogass el",
    affiliateTitle: "Affiliate közzététel:",
    affiliateText: "Ez az oldal affiliate linkeket tartalmaz. Minősített művelet után jutalékot kaphatunk. A kapcsolat nem irányítja az előrejelzés számításait; a partnersorrend kereskedelmileg beállítható.",
  },
  tools: {
    title: "Fogadási eszközök",
    subtitle: "Ingyenes kalkulátorokkal válts oddsot, becsülj hozamot, kezeld a tétméretet, és hasonlítsd az árat a saját fair oddsodhoz.",
    ...
    kelly: "Kelly-kritérium — oktatási tétbecslés, amely ingadozó és a megadott feltételezések pontosságától függ.",
    winPercent: "Győzelem % becslés",
    recommendedStake: "Számított tétbecslés",
