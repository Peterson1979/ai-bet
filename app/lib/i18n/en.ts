 ...
 seoTitle: "MatchSignal – Free AI Betting Tips",
  ...
  footer: {
   ...
   marketDepthFeatureTitle: "Market Depth",
    ...
    impliedProbFeatureTitle: "Market Probability",
    impliedProbFeatureDesc: "Each match shows the implied probability derived from bookmaker odds — indicating how likely the market considers the home team to win.",
