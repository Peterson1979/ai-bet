...
const fr: DeepPartial<Translation> = {
  ...
  footer: {
    ...
    betIntelligenceDesc: "MatchSignal combine des cotes en temps réel provenant de plusieurs bookmakers avec un contexte de match généré par IA, pour vous aider à comparer les offres et comprendre chaque rencontre en un coup d'œil.",
    matchPreviewFeatureTitle: "Aperçu IA du match",
    matchPreviewFeatureDesc: "Un résumé court et neutre pour chaque match généré par IA, donnant un contexte rapide sur la rencontre et la compétition.",
    oddsComparisonFeatureTitle: "Comparaison des cotes",
    oddsComparisonFeatureDesc: "Nous affichons les meilleures cotes disponibles pour chaque match, collectées et comparées en temps réel entre plusieurs bookmakers.",
    marketDepthFeatureTitle: "Profondeur du marché",
    marketDepthFeatureDesc: "Chaque match affiche le nombre de bookmakers proposant actuellement des cotes, donnant une idée de l'activité du marché.",
...
const es: DeepPartial<Translation> = {
  ...
  odds: "Cuotas", confidence: "Confianza", edge: "Ventaja", risk: "Riesgo",
  ...
  footer: {
    ...
    betIntelligenceDesc: "MatchSignal combina cuotas en tiempo real de múltiples casas de apuestas con contexto de partido generado por IA, ayudándote a comparar ofertas y entender cada encuentro de un vistazo.",
    matchPreviewFeatureTitle: "Vista previa IA del partido",
    matchPreviewFeatureDesc: "Un resumen breve y neutral para cada partido generado por IA, dando contexto rápido sobre el encuentro y la competición.",
    oddsComparisonFeatureTitle: "Comparación de cuotas",
    oddsComparisonFeatureDesc: "Mostramos las mejores cuotas disponibles para cada partido, recopiladas y comparadas en tiempo real entre múltiples casas de apuestas.",
    marketDepthFeatureTitle: "Profundidad del mercado",
    marketDepthFeatureDesc: "Cada partido muestra cuántas casas de apuestas ofrecen actualmente cuotas, dando una idea de cuán activamente se está cotizando el mercado.",
...
const it: DeepPartial<Translation> = {
  ...
  odds: "Quote", confidence: "Fiducia", edge: "Vantaggio", risk: "Rischio",
  ev: "Valore atteso (EV)",
  viewOdds: "Vedi quote",
  ...
  footer: {
    ...
    betIntelligenceDesc: "MatchSignal combina quote in tempo reale da più bookmaker con contesto della partita generato dall'IA, aiutandoti a confrontare le offerte e capire ogni incontro a colpo d'occhio.",
    matchPreviewFeatureTitle: "Anteprima IA della partita",
    matchPreviewFeatureDesc: "Un breve riassunto neutrale per ogni partita generato dall'IA, che fornisce un contesto rapido sull'incontro e sulla competizione.",
    oddsComparisonFeatureTitle: "Confronto quote",
    oddsComparisonFeatureDesc: "Mostriamo le migliori quote disponibili per ogni partita, raccolte e confrontate in tempo reale tra più bookmaker.",
    marketDepthFeatureTitle: "Profondità di mercato",
    marketDepthFeatureDesc: "Ogni partita mostra quanti bookmaker offrono attualmente quote, dando un'idea di quanto attivamente viene prezzato il mercato.",
...
const pt: DeepPartial<Translation> = {
  ...
  odds: "Odds", confidence: "Confiança", edge: "Vantagem", risk: "Risco",
  ev: "Valor esperado (EV)",
  viewOdds: "Ver odds",
  ...
  footer: {
    ...
    betIntelligenceDesc: "O MatchSignal combina odds em tempo real de várias casas de apostas com contexto de jogo gerado por IA, ajudando-o a comparar ofertas e entender cada confronto rapidamente.",
    matchPreviewFeatureTitle: "Pré-visualização IA do jogo",
    matchPreviewFeatureDesc: "Um resumo curto e neutro para cada jogo gerado por IA, dando contexto rápido sobre o confronto e a competição.",
    oddsComparisonFeatureTitle: "Comparação de odds",
    oddsComparisonFeatureDesc: "Mostramos as melhores odds disponíveis para cada jogo, recolhidas e comparadas em tempo real entre várias casas de apostas.",
    marketDepthFeatureTitle: "Profundidade do mercado",
    marketDepthFeatureDesc: "Cada jogo mostra quantas casas de apostas oferecem atualmente odds, dando uma ideia de quão ativamente o mercado está a ser cotado.",
...
const ar: DeepPartial<Translation> = {
  ...
  odds: "الأوفاق", confidence: "الثقة", edge: "الميزة", risk: "المخاطرة",
  ev: "القيمة المتوقعة",
  ...
  footer: {
    ...
    betIntelligenceDesc: "يجمع MatchSignal بين أسعار الرهان الفورية من عدة مواقع رهان مع سياق المباراة المُولّد بالذكاء الاصطناعي، لمساعدتك على مقارنة العروض وفهم كل مباراة بسرعة.",
    matchPreviewFeatureTitle: "معاينة المباراة بالذكاء الاصطناعي",
    matchPreviewFeatureDesc: "ملخص قصير ومحايد لكل مباراة يُولّده الذكاء الاصطناعي، يمنحك سياقاً سريعاً عن المباراة والبطولة.",
    oddsComparisonFeatureTitle: "مقارنة الأسعار",
    oddsComparisonFeatureDesc: "نعرض أفضل الأسعار المتاحة لكل مباراة، مجمّعة ومقارنة في الوقت الفعلي بين عدة مواقع رهان.",
    marketDepthFeatureTitle: "عمق السوق",
    marketDepthFeatureDesc: "تعرض كل مباراة عدد مواقع الرهان التي تقدم حالياً أسعاراً لها، مما يعطي فكرة عن مدى نشاط تسعير السوق.",
...
const zh: DeepPartial<Translation> = {
  ...
  odds: "赔率", confidence: "置信度", edge: "优势", risk: "风险",
  ev: "期望值 (EV)",
  viewOdds: "查看赔率",
  ...
  footer: {
    ...
    betIntelligenceDesc: "MatchSignal 结合来自多家博彩公司的实时赔率与AI生成的比赛背景信息，帮助您比较优惠并快速了解每场比赛。",
    matchPreviewFeatureTitle: "AI赛事预览",
    matchPreviewFeatureDesc: "由AI生成的每场比赛简短中立摘要，快速了解赛事和赛事背景。",
    oddsComparisonFeatureTitle: "赔率比较",
    oddsComparisonFeatureDesc: "我们展示每场比赛的最佳可用赔率，实时收集并比较多家博彩公司的数据。",
    marketDepthFeatureTitle: "市场深度",
    marketDepthFeatureDesc: "每场比赛显示当前有多少家博彩公司提供赔率，让您了解市场定价的活跃程度。",
...
const ja: DeepPartial<Translation> = {
  ...
  odds: "オッズ", confidence: "信頼度", edge: "優位性", risk: "リスク",
  ev: "期待値 (EV)",
  viewOdds: "オッズを見る",
  ...
  footer: {
    ...
    betIntelligenceDesc: "MatchSignalは複数のブックメーカーからのリアルタイムオッズとAI生成の試合コンテキストを組み合わせ、オファーの比較と各試合の理解を一目で可能にします。",
    matchPreviewFeatureTitle: "AI試合プレビュー",
    matchPreviewFeatureDesc: "AIが生成する各試合の簡潔で中立的な要約。試合と大会についての素早いコンテキストを提供します。",
    oddsComparisonFeatureTitle: "オッズ比較",
    oddsComparisonFeatureDesc: "各試合の最良の利用可能なオッズを表示し、複数のブックメーカー間でリアルタイムに収集・比較します。",
    marketDepthFeatureTitle: "市場の深さ",
    marketDepthFeatureDesc: "各試合で現在何社のブックメーカーがオッズを提供しているかを表示し、市場がどれだけ活発に値付けされているかの目安を示します。",
...
const hi: DeepPartial<Translation> = {
  ...
  odds: "ऑड्स", confidence: "विश्वास", edge: "बढ़त", risk: "जोखिम",
  ...
  footer: {
    ...
    betIntelligenceDesc: "MatchSignal कई बुकमेकरों से रीयल-टाइम ऑड्स को AI-जनित मैच संदर्भ के साथ जोड़ता है, जिससे आप ऑफ़र की तुलना कर सकें और हर मैच को एक नज़र में समझ सकें।",
    matchPreviewFeatureTitle: "AI मैच पूर्वावलोकन",
    matchPreviewFeatureDesc: "AI द्वारा जनित प्रत्येक मैच का संक्षिप्त, तटस्थ सारांश, जो मैच और प्रतियोगिता के बारे में त्वरित संदर्भ देता है।",
    oddsComparisonFeatureTitle: "ऑड्स तुलना",
    oddsComparisonFeatureDesc: "हम प्रत्येक मैच के लिए सर्वोत्तम उपलब्ध ऑड्स दिखाते हैं, जो कई बुकमेकरों में रीयल-टाइम में एकत्रित और तुलना की जाती हैं।",
    marketDepthFeatureTitle: "बाजार की गहराई",
    marketDepthFeatureDesc: "प्रत्येक मैच दिखाता है कि वर्तमान में कितने बुकमेकर इस पर ऑड्स प्रदान कर रहे हैं, जिससे बाजार की सक्रियता का अंदाजा मिलता है।",
