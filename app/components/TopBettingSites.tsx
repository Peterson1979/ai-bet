// app/components/TopBettingSites.tsx
import { getSidebarSites } from "@/app/lib/affiliates";

function getRatingColor(rating: number) {
  if (rating >= 9.7) return "text-emerald-300 border-emerald-400/40 bg-emerald-500/10";
  if (rating >= 9.4) return "text-cyan-300 border-cyan-400/40 bg-cyan-500/10";
          ...
          >
            ...
            <div className="relative flex items-center justify-between gap-4">
              ...
              <div className="flex items-center gap-4">
                {/* Logo placeholder — cseréld <Image> komponensre ha van logód */}
                <div className="relative flex h-12 w-12 items-center justify-center rounded-xl border border-cyan-400/25 bg-[#111C31] shadow-[inset_0_0_20px_rgba(0,0,0,0.7)]">
              ...
              {/* RATING */}
              <div className={`rounded-xl border px-3 py-2 flex-shrink-0 ${ratingStyle}`}>
                <div className="text-[10px] font-bold uppercase tracking-wider">Rating</div>
                <div className="mt-1 text-xl font-black">{site.rating}</div>
              </div>
            </div>
            ...
            <div className="relative mt-5 flex items-center justify-between">
              ...
              <div className="
                ...
                px-4 py-2 text-[11px] font-bold uppercase tracking-wider text-cyan-300
